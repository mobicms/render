...
* GitHub Issues: <https://github.com/mobicms/render/issues>
...
* mobicms/render follows the **[PSR-12 coding standard][psr-12]**. Please
  ensure your code does, too.
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  mobicms/render has Travis CI automatically running tests for pull requests.
...
[github]: https://github.com/mobicms/render
[contributor code of conduct]: https://github.com/mobicms/render/blob/master/.github/CODE_OF_CONDUCT.md
